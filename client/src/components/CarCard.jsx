...
const CardCard = ({bike}) => {
  ...
  return (
    <div onClick={()=> {navigate(`/bike-details/${bike._id}`); scrollTo(0,0)}} className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer'>
      ...
      <div className='relative h-48 overflow-hidden'> 
        ...
        {bike.isAvaliable && <p className='absolute top-4 left-4 bg-primary/90 text-white text-xs px-2.5 py-1 rounded-full'>Available Now</p>}
      ...
      <div className='p-4 sm:p-5'>
        ...
        {/* <div className='mt-4 grid grid-cols-2 gap-y-2 text-gray-600'>
            ...
            <div className='flex items-center text-sm text-muted-foreground'>
                <img src={assets.bike_icon} alt="" className='h-4 mr-2'/>
