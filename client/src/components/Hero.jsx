    ...
    return (
        <motion.div
            ...
            <motion.h1 initial={{ y: 50, opacity: 0 }}
                ...
                className='text-4xl md:text-5xl font-semibold'>Bikes for Rent</motion.h1>
       ...
       onSubmit={handleSearch} className='flex flex-col md:flex-row items-start md:items-center justify-between p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-10 min-md:ml-8'>
            ...
            <motion.div
                ...
                className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 w-full max-w-[95vw] mx-auto px-4 overflow-hidden"
            >
                {/* Left Bike (Facing Right) */}
                <div className="w-full md:w-1/2 flex justify-center">
                    <motion.img
                        src={assets.bmw}
                        alt="bike left"
                        className="h-44 sm:h-56 md:h-64 lg:h-72 scale-x-[-1] object-contain"
