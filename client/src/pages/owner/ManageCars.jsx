...
const ManageCars = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      ...
      <Title title="Manage Bikes" subTitle="View all listed cars, update their details, or remove them from the booking platform." />
