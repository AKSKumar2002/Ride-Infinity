...
const BikeDetails = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!bike || !bike._id) {
            toast.error("Bike details not loaded");
            return;
        }

        try {
            const { data } = await axios.post('/api/bookings/create', {
                bike: bike._id,  // ✅ Use the actual bike ObjectId
                pickupDate,
                returnDate
            });
    ...
    useEffect(() => {
        console.log("bikes from context:", bikes);  // ✅ Check if it's undefined or empty
    ...
    return bike ? (
        <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
            ...
            <button onClick={() => navigate("/bikes")} className='flex items-center gap-2 mb-6 text-gray-500 cursor-pointer'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
                ...
                <motion.div
                    ...
                    <motion.img
                        ...
                        src={bike.image} alt="" className='w-full h-auto md:max-h-100 object-cover rounded-xl mb-6 shadow-md' />
                  ...
                  {[
                    ...
                    {icon: assets.bike_icon, text: bike.transmission},
                ...
                <motion.form
                    ...
                    <p className='text-center text-sm'>No credit biked required to reserve</p>
