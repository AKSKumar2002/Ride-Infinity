...
const Bikes = () => {
  ...
  const searchbikeAvailablity = async () =>{
    const {data} = await axios.post('/api/bookings/check-availability', {pickupDate, returnDate})
    if (data.success) {
  ...
  return (
    <div>
      ...
      className='px-6 md:px-16 lg:px-24 xl:px-32 mt-10'>
        <p className='text-gray-500 xl:px-20 max-w-7xl mx-auto'>Showing {filteredbikes.length} Bikes</p>
